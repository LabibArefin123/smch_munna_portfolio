    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <select name="recommended" id="recommended" class="form-control">
                ...
                <option value="0" {{ old('recommended', $patient->recommended) == 0 ? 'selected' : '' }}>
                    No
                </option>

                <option value="1" {{ old('recommended', $patient->recommended) == 1 ? 'selected' : '' }}>
                    Yes
                </option>
    ...
    <div class="col-md-6 recommendation-fields">
        ...
        <div class="form-group">
            ...
            <input type="text" name="recommended_doctor"
                ...
                value="{{ old('recommended_doctor', $patient->recommended_doctor) }}" placeholder="Enter Doctor Name">
