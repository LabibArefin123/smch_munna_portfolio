        ...
        <div class="card-body">
            <div class="row" id="oldDescriptionPreview">
                ...
                @php
                    ...
                    $patientFolder = Str::slug($patient->name);
                @endphp

                @if (!empty($oldImages))
                    @foreach ($oldImages as $index => $image)
                        @php
                            $path = public_path('uploads/images/patients/' . $patientFolder . '/' . $image);
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 mb-4 old-description-card">
                            <div class="card shadow h-100 border-0">
                                ...
                                <img src="{{ asset('uploads/images/patients/' . $patientFolder . '/' . $image) }}"
                                    class="card-img-top" style="height:180px;object-fit:cover;" alt="Description Image">
                                ...
                                <div class="card-body p-2">
                                    ...
                                    <button type="button"
                                        class="btn btn-danger btn-block btn-sm remove-old-description"
                                        data-index="{{ $index }}">
                ...
                @else
                    <div class="col-12 text-center">
                        <img src="{{ asset('uploads/images/default.jpg') }}" class="img-thumbnail"
                            style="max-height:220px;" alt="No Image">
                    </div>
                @endif
